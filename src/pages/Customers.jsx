            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {customers.map((customer) => (
                <tr key={customer.id} className="hover:bg-gray-50 transition duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{customer.eponimia}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    {(userRole === 'ROLE_SUPERVISOR' || (userRole.startsWith('ROLE_PARTNER') && decodedToken && customer.userId === parseInt(decodedToken.sub))) && (
                      <button
